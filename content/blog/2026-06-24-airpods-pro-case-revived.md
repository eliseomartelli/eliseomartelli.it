...
title: "AirPods Pro Case: Revived for €20"
date: "2026-06-24 13:30:00"
excerpt: "It turns out fixing the unfixable only takes fifteen minutes and a bit of patience."
tags:
  - Apple
  - Hardware
description: "It turns out fixing the unfixable only takes fifteen minutes and a bit of patience."
---

Last week, I wrote that my [AirPods Pro case was dead](/blog/2026-06-16-airpods-pro-case-dead/). The battery wouldn't hold a charge, and Apple's only solution was to charge me €100+ for a replacement case. 
...
1. Detach the hall sensor.
2. Disconnect the flex cables for the setup button and the Lightning port.
3. Remove the motherboard.
4. Remove the old battery. It is held down by strong adhesive, so applying some gentle heat (a hair dryer works fine) makes it much easier to pry out.
