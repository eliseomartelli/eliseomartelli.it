...
tags:
  ...
  - privacy
  - selfhost
description: "A password manager is one of the most essential tools that a modern citizen of the internet should have. Learn how to self-host Bitwarden with Docker."
---

A **password manager** is one of the most essential tools that a modern _citizen_ of the internet should have since 99.99% of services require one to provide a series of characters to later login.  
...
My journey with password managers started a _long time ago_ but now I've been using BitWarden for over an year and at the beginning of this month I've moved to a self hosted solution.
...
_It's not always fun and games_ but tools like Docker can come to the rescue!  
