...
<RatingBar label="Sound Quality" value={8.5} featured />
<RatingBar label="Noise Cancellation" value={8} featured />
<RatingBar label="Build & Comfort" value={7} featured />
<RatingBar label="Value for Money" value={6} featured />
<RatingBar label="Overall" value={7.5} featured />
