export const tagletClassNames: { [name: string]: string } = {
  ...
  programming: "bg-stone-50 border-stone-300",
  misc: "bg-rose-50 border-rose-300",
  studies: "bg-violet-50 border-violet-300",
